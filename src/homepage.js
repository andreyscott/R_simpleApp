        ...
        <nav className='text-right'>
            <div className='justify-center'>
                <h1 className='font-bold uppercase p-4 border-b-2  border-gray-400'>
                    <a href='/' className='hover:text-gray-800' alt='Food Ninja' >
                        food Ninja
                    </a>
                </h1>
            </div>
            <ul className='text-sm mt-6'>
                ...
                <li className='py-1 flex'>
                    <a href='#'><span className='px-4 flex justify-end  border-r-4 border-white'>About</span>
                ...
                <li className='flex py-1'>
                    <a href='#'><span className='px-4 flex justify-end  border-r-4 border-white'>Content</span>
